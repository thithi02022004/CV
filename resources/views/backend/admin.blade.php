            ...
            <nav class="navbar navbar-expand-lg main-navbar sticky">
              ...
              <span class="badge headerBadge1">
                6 </span> </a>
                    ...
                    <li class="dropdown">
                        <a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user"> <img alt="image" src="{{ asset('backend/') }}assets/img/user.png" class="user-img-radious-style"> <span class="d-sm-none d-lg-inline-block"></span></a>
                        <div class="dropdown-menu dropdown-menu-right pullDown">
                            ...
                            <a href="auth-login.html" class="dropdown-item has-icon text-danger"> <i class="fas fa-sign-out-alt"></i> Logout
                            </a>
                        </div>
                    </li>
                </ul>
            ...
            <div class="main-sidebar sidebar-style-2">
                <aside id="sidebar-wrapper">
                    <div class="sidebar-brand">
                        <a href="index.html"> <img alt="image" src="{{ asset('backend/') }}assets/img/logo.png" class="header-logo" /> <span class="logo-name">Otika</span>
                        </a>
                    </div>
                    <ul class="sidebar-menu">
                        <li class="menu-header">Main</li>
                        <li class="dropdown active">
                            <a href="index.html" class="nav-link"><i data-feather="monitor"></i><span>Thống kê</span></a>
                        </li>
                        <li class="dropdown">
                            <a href="#" class="menu-toggle nav-link has-dropdown"><i
                  data-feather="briefcase"></i><span>Thông tin cá nhân</span></a>
                            <ul class="dropdown-menu">
                                {{-- <li><a class="nav-link" href="{{ route('infomation_api') }}">Quản lý thông tin cá nhân api</a></li> --}}
                                <li><a class="nav-link" href="{{ route('show_infomation') }}">Thông tin</a></li>
                                {{-- <li><a class="nav-link" href="{{ route('experience_api') }}">Kinh nghiệm - kỹ năng api</a></li> --}}
                                <li><a class="nav-link" href="{{ route('list_experience') }}">Kinh nghiệm - kỹ năng</a></li>
                                {{-- <li><a class="nav-link" href="{{ route('education_api') }}">Học vấn api</a></li> --}}
                                <li><a class="nav-link" href="{{ route('list_education') }}">Quản lý trình độ học vấn</a></li>
                            </ul>
                        </li>
                        <li class="dropdown">
